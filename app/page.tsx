...
function Publication({ form, annotations, blocks, extras, editor, update, updateBlock, addExtra, removeExtra, updateExtra, removeAnnotation, onChooseImage, onSelectSource, onSelectModern, onAddNote, onLoadSource, onDeleteModern }: {
  ...
  onChooseImage?: (file?: File) => void; onSelectSource?: () => void; onSelectModern?: () => void; onAddNote?: (area: "source" | "modern") => void; onLoadSource?: () => void; onDeleteModern?: () => void;
}) {

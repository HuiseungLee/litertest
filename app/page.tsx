...
function Publication({ form, annotations, blocks, extras, publishedAt, editor, update, updateBlock, addExtra, removeExtra, updateExtra, removeAnnotation, onChooseImage, onSelectSource, onSelectModern, onAddNote, onLoadSource, onSearchSources, onDeleteModern, onRestoreModern }: {
